...
class TransactionTimeRescanTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine BEW and create transactions
        ...
        # generate some bew to create transactions and check blockcount
        ...
        # send 10 bew to user's first watch-only address
        self.log.info('Send 10 bew to user')
        ...
        # send 5 bew to our second watch-only address
        self.log.info('Send 5 bew to user')
        ...
        # send 1 bew to our third watch-only address
        self.log.info('Send 1 bew to user')
        ...
        if not self.options.descriptors:
            ...
            with concurrent.futures.ThreadPoolExecutor(max_workers=1) as thread:
                with minernode.assert_debug_log(expected_msgs=["Rescan started from block 2013e6667f33ca0c77ceb427a87ed3360ea8d16f772175d42e62e5b6422aaffc... (slow variant inspecting all blocks)"], timeout=5):
