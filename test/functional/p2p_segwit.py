...
class TestP2PConn(P2PInterface):
    ...
    def announce_block_and_wait_for_getdata(self, block, use_header, timeout=100000):
        with p2p_lock:
            self.last_message.pop("getdata", None)
    ...
    def request_block(self, blockhash, inv_type, timeout=100000):
        with p2p_lock:
...
class SegWitTest(BitcoinTestFramework):
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older bewcored's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let bewcored fill it in.
