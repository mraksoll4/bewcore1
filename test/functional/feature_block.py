...
class FullBlockTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure bewcored isn't accepting b26
        ...
        # Extend the b28 chain to make sure bewcored isn't accepting b28
        ...
        # bewcored doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the bewcore code has custom code which does so);
    ...
    def send_blocks(self, blocks, success=True, reject_reason=None, force_send=False, reconnect=False, timeout=5000):
