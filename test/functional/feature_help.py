...
"""Verify that starting bewcore with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bewcore with -h for help text")
        ...
        self.log.info("Start bewcore with -version for version information")
        ...
        self.log.info("Start bewcored with -fakearg to make sure it does not start")
