...
Arguments:
    <base_directory> - The base directory of a bewcore source code repository.
...
Arguments:
    <file> - A source file in the bewcore repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The Bewcore
