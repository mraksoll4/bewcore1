...
bech32_templates = [
  ...
  ('dpc',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('dpc',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('dpc',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('dpc',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
