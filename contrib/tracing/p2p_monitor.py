...
""" Interactive bewcored P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for BewCore can enable. It uses BCC
...
def main(bewcored_path):
    ...
    bewcored_with_usdts.enable_probe(
