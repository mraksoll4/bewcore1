...
complete --command bewcore-qt --no-files

# Extract options
function __fish_bewcoreqt_get_options
...
complete \
    --command bewcore-qt \
    --arguments "(__fish_bewcoreqt_get_options --nofiles)"
