...
# Extract options
function __fish_bewcore_tx_get_options
...
# Extract commands
function __fish_bewcore_tx_get_commands
...
complete \
    --command bewcore-tx \
    --condition "not __fish_bewcore_seen_cmd (__fish_bewcore_tx_get_commands --commandsonly)" \
    --arguments "(__fish_bewcore_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command bewcore-tx \
    --arguments "(__fish_bewcore_tx_get_commands)" \
    --no-files
