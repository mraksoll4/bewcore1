...
complete --command bewcored --no-files

# Extract options
function __fish_bewcored_get_options
...
complete \
    --command bewcored \
    --arguments "(__fish_bewcored_get_options --nofiles)"
