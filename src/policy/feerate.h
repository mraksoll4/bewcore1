...
const std::string CURRENCY_UNIT = "BEW"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    BEW_KVB,      //!< Use BEW/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::BEW_KVB) const;
