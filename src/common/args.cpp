...
const char * const BITCOIN_CONF_FILENAME = "bewcore.conf";
...
{
    // Windows: C:\Users\Username\AppData\Roaming\Bewcore
    // macOS: ~/Library/Application Support/Bewcore
    // Unix-like: ~/.bewcore
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Bewcore";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Bewcore";
#else
    // Unix-like
    return pathRet / ".bewcore";
#endif
#endif
}
