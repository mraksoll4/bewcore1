...
/**
  Bewcore GUI main class. This class represents the main window of the Bewcore UI. It communicates with both the client and
...
public:
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a bewcore wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Bewcore Transaction from file or clipboard */
