    ...
    return
         {
             ...
             {RPCResult::Type::STR, "address", /*optional=*/true, "The Bewcore address (only if a well-defined address exists)"},
...
static RPCHelpMan decodepsbt()
{
    return RPCHelpMan{
        "decodepsbt",
        "Return a JSON object representing the serialized, base64-encoded partially signed Bewcore transaction.",
                {
...
static RPCHelpMan combinepsbt()
{
    return RPCHelpMan{"combinepsbt",
                "\nCombine multiple partially signed Bewcore transactions into one transaction.\n"
