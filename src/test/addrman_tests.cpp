...
BOOST_AUTO_TEST_CASE(addrman_select)
{
    ...
    CService addr3 = ResolveService("250.3.2.2", 45000);
    CService addr4 = ResolveService("250.3.3.3", 45000);
...
BOOST_AUTO_TEST_CASE(addrman_getaddr)
{
    ...
    CAddress addr2 = CAddress(ResolveService("250.251.2.2", 45000), NODE_NONE);
...
BOOST_AUTO_TEST_CASE(caddrinfo_get_tried_bucket_legacy)
{
    ...
    CAddress addr2 = CAddress(ResolveService("250.1.1.1", 45000), NODE_NONE);
...
BOOST_AUTO_TEST_CASE(caddrinfo_get_new_bucket_legacy)
{
    ...
    CAddress addr2 = CAddress(ResolveService("250.1.2.1", 45000), NODE_NONE);
...
BOOST_AUTO_TEST_CASE(load_addrman)
{
    ...
    addr2 = Lookup("250.7.2.2", 45000, false);
    BOOST_CHECK(addr2.has_value());
    addr3 = Lookup("250.7.3.3", 45000, false);
    BOOST_CHECK(addr3.has_value());
    addr3 = Lookup("250.7.3.3"s, 45000, false);
    BOOST_CHECK(addr3.has_value());
    addr4 = Lookup("250.7.3.3\0example.com"s, 45000, false);
