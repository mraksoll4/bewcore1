...
{
    while (!(CheckProofOfWork(starting_header.GetYespowerPoWHash(), starting_header.nBits, Params().GetConsensus()) && CheckProofOfWork(starting_header.GetArgon2idPoWHash(), starting_header.nBits, Params().GetConsensus()))) {
