...
// amounts 1 .. 10000
#define NUM_MULTIPLES_1BEW 10000

// amounts 50 .. 42000000
#define NUM_MULTIPLES_50BEW 480000
...
BOOST_AUTO_TEST_CASE(compress_amounts)
{
    ...
    BOOST_CHECK(TestPair(21000000*COIN, 0x280de80));
    ...
    for (uint64_t i = 1; i <= NUM_MULTIPLES_1BEW; i++)
        BOOST_CHECK(TestEncode(i * COIN));

    for (uint64_t i = 1; i <= NUM_MULTIPLES_50BEW; i++)
