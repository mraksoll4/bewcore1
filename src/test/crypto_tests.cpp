...
BOOST_AUTO_TEST_CASE(sha256_testvectors) {
    ...
    TestSHA256("As Bewcore relies on 80 byte header hashes, we want to have an example for that.",
               "9eb59b0c396d8307b88c5040289cd92a55ef71aad79495779dc3c9f44e4be300");
