...
([`valgrind.supp`](https://github.com/mraksoll4/bewcore/blob/master/contrib/valgrind.supp))
which includes known Valgrind warnings in our dependencies that cannot be fixed
in-tree. Example use:

```shell
$ valgrind --suppressions=contrib/valgrind.supp src/test/test_bewcore
$ valgrind --suppressions=contrib/valgrind.supp --leak-check=full \
      --show-leak-kinds=all src/test/test_bewcore --log_level=test_suite
...
# A coverage report will now be accessible at `./test_bewcore.coverage/index.html`,
