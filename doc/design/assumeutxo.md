...
Assumeutxo is a feature that allows fast bootstrapping of a validating bewcored
instance.
...
considered active. This is the "traditional" mode of operation for bewcore.
